...
const TRANSLATIONS = {
  en: {
    ...
    legalRepresented: 'Represented by: Chrisna Lungala<br>E-Mail: composer@chrisnalungala.com',
    ...
    privacyA5: "Under GDPR and similar laws, you can ask to see, correct, or delete any data held about you. Since we don't collect personal data here, there's nothing to access or delete. If you have questions, reach out at <a href=\"mailto:composer@chrisnalungala.com\">composer@chrisnalungala.com</a>.",
  ...
  de: {
    ...
    legalRepresented: 'Vertreten durch: Chrisna Lungala<br>E-Mail: composer@chrisnalungala.com',
    ...
    privacyA5: 'Nach DSGVO und ähnlichen Gesetzen können Sie verlangen, Daten einzusehen, zu korrigieren oder zu löschen. Da wir hier keine personenbezogenen Daten sammeln, gibt es nichts einzusehen oder zu löschen. Bei Fragen wenden Sie sich an <a href="mailto:composer@chrisnalungala.com">composer@chrisnalungala.com</a>.',
  ...
  fr: {
    ...
    legalAddress: 'Chrisna Lungala<br>Fingerkrautanger 17<br>80937 Munich',
    legalRepresented: 'Représenté par : Chrisna Lungala<br>E-mail : composer@chrisnalungala.com',
    ...
    privacyA5: 'Conformément au RGPD et aux lois similaires, vous pouvez demander à consulter, corriger ou supprimer des données vous concernant. Comme nous ne collectons pas de données personnelles ici, il n\'y a rien à consulter ou supprimer. Si vous avez des questions, contactez-nous à <a href="mailto:composer@chrisnalungala.com">composer@chrisnalungala.com</a>.',
